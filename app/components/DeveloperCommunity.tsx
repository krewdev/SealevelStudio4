...
const SAMPLE_POSTS: ForumPost[] = [
  ...
  },
  {
    ...
    content: 'Building a next-gen NFT marketplace on Solana. Need React/TypeScript expert with Web3 experience. Remote work, competitive salary.',
    author: 'NFTPlatform',
    avatar: '🎭',
    ...
    likes: 5,
    replies: 2,
    tags: ['react', 'typescript', 'nft', 'frontend'],
    budget: '$80k-120k',
    urgency: 'medium'
  },
  {
    id: '6',
    type: 'discussion',
    title: 'Best Practices for Solana Program Security Audits',
    content: 'What are your go-to security practices when developing Solana programs? Any recommended audit firms or tools?',
    author: 'SecurityDev',
    avatar: '🔒',
    ...
    likes: 28,
    replies: 19,
    tags: ['security', 'audit', 'solana', 'best-practices']
  }
];
...
export function DeveloperCommunity({ onBack }: DeveloperCommunityProps) {
                  ...
                  <div className="flex items-start space-x-4 flex-1">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center space-x-2 mb-2 flex-wrap">
                        ...
                        <span className={`px-2 py-1 rounded-full text-xs font-medium ${config.color} text-white flex-shrink-0`}>
                          {config.label}
                        </span>
                        {post.budget && (
