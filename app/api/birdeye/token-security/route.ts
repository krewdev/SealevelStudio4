// Next.js API route to proxy Birdeye token security requests
// Get security-related information about tokens
...
export async function GET(request: NextRequest) {
  try {
    ...
    const url = `${BIRDEYE_API_BASE}/defi/token_security?address=${encodeURIComponent(address)}`;
    ...
    console.error('Birdeye token security proxy error:', error);
    return NextResponse.json(
